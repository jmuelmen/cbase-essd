...
\begin{figure*}
  \centering
  <<cbase-base,dev='tikz',fig.width=7,fig.height=3,out.width='0.95\\textwidth',message=FALSE,cache=FALSE,echo=FALSE,results='hide'>>=
  vis.mean(cbase, 14)
  @
...
\begin{figure}
  \centering
  <<cbase-rmse,dev='tikz',fig.width=3,fig.height=2,out.width='0.5\\textwidth',message=FALSE,cache=FALSE,echo=FALSE>>=
  cbase %>% 
...
\begin{figure*}
  \centering
  <<cbase-uncert-quantiles,dev='tikz',fig.width=7,fig.height=9.5,out.width='0.95\\textwidth',message=FALSE,cache=FALSE,echo=FALSE,results='hide'>>=
