...
<<eval-tune-setup-self,cache=TRUE,results='hide',echo=FALSE>>=
@ 
...
\begin{figure*}
  \centering
  <<eval-qual-after-other-cuts,dev='tikz',fig.width=7,fig.height=3.2,out.width='0.95\\textwidth',message=FALSE,echo=FALSE,results='hide',cache=TRUE>>=
  @
...
\begin{figure*}
  \centering
  <<eval-svm-corr,dev='tikz',fig.width=7,fig.height=5,out.width='0.95\\textwidth',message=FALSE,cache=TRUE,echo=FALSE,results='hide'>>=
  @
...
\begin{figure*}
  \centering
  <<eval-uncertainty,dev='tikz',fig.width=7,fig.height=5,out.width='0.95\\textwidth',message=FALSE,cache=TRUE,echo=FALSE,results='hide'>>=
  @
...
\begin{figure*}
  \centering
  <<2bgeoprof-cbase-comparison,dev='tikz',fig.width=7,fig.height=5,out.width='0.95\\textwidth',message=FALSE,cache=TRUE,echo=FALSE,results='hide'>>=
  @
  \caption{Scatter plot of 2B-GEOPROF-LIDAR lidar-only versus CBASE \CBH{}.  For
    ...
    difference between 2B-GEOPROF-LIDAR and CBASE is \Sexpr{abs(res$stats$bias * 1e-3)}~\unit{km},
    the root mean square difference is \Sexpr{res$stats$rmse * 1e-3}~\unit{km}, and the
    correlation coefficient is \Sexpr{res$stats$cor}.}
