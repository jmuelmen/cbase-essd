...
<<eval-setup,cache=FALSE,echo=FALSE>>=
@ 
<<eval-tune-setup,cache=FALSE,results='hide',echo=FALSE>>=
@ 
...
-- so both the cloud base estimate and the uncertainty estimate are quite good.
...
\begin{figure}
  \centering
  <<combo-plot,dev='tikz',fig.width=3,fig.height=2,out.width='0.5\\textwidth',message=FALSE,cache=FALSE,echo=FALSE>>=
  @
...
\begin{figure}
  \centering
  <<combo-eval-pull,dev='tikz',fig.width=4,fig.height=3,out.width='0.5\\textwidth',message=FALSE,cache=FALSE,echo=FALSE>>=
  @
