...
special weather reports (METARs and SPECIs, collectively referred to as METARs
henceforth; \verb+https://library.wmo.int/pmb_ged/wmo_49-v2_2013_en.pdf+).  In
METARs, cloud base heights are measured by ceilometer over a period of time
(tens of minutes) and objectively grouped into cloud layers and their respective
